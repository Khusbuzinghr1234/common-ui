...
var require_react_dom_development = __commonJS({
  "node_modules/react-dom/cjs/react-dom.development.js"(exports) {
    ...
    "production" !== process.env.NODE_ENV && (function() {
      ...
      var React18 = __require("react"), Internals = {
        d: {
          f: noop,
          r: function() {
            throw Error(
...
function createStyledContext(defaultValues, namespace = "") {
  "use no memo";
  const createReactContext = React[Math.random(), "createContext"], useReactMemo = React[Math.random(), "useMemo"], useReactContext = React[Math.random(), "useContext"], OGContext = createReactContext(defaultValues), OGProvider2 = OGContext.Provider, Context = OGContext, scopedContexts = /* @__PURE__ */ new Map(), LastScopeInNamespace = createReactContext(namespace);
...
function useMedia(componentContext, debug) {
  ...
  const state2 = useSyncExternalStore(subscribe, () => {
...
import { createContext as createContext2, useCallback as useCallback2, useContext as useContext2, useId, useSyncExternalStore as useSyncExternalStore2 } from "react";
var ThemeStateContext = createContext2("");
...
var useThemeState = (props, isRoot = false, keys, schemeKeys) => {
  const {
    disable
  } = props, parentId = useContext2(ThemeStateContext);
...
Looked for theme${props.name ? ` "${props.name}"` : ""}${props.componentName ? ` (component: ${props.componentName})` : ""}, but no parent theme context was found (parentId: ${parentId}).` : MISSING_THEME_MESSAGE);
  ...
  const id = useId(), subscribe3 = useCallback2((cb) => (listenersByParent[parentId] || (listenersByParent[parentId] = /* @__PURE__ */ new Set()), listenersByParent[parentId].add(id), allListeners.set(id, () => {
  ...
  const state2 = useSyncExternalStore2(subscribe3, getSnapshot, getSnapshot);
...
var useThemeWithState = (props, isRoot = false) => {
  const keys = useRef2(null), schemeKeys = useRef2(null), themeState = useThemeState(props, isRoot, keys, schemeKeys);
...
var useInsertEffectCompat = isWeb ? React3.useInsertionEffect || useIsomorphicLayoutEffect : () => {
};
...
import React5, { Children, cloneElement, forwardRef, isValidElement, useRef as useRef3 } from "react";
...
var ClientOnlyContext = createContext3(false);
...
function ThemeDebug({
  ...
  if (process.env.NODE_ENV === "development") {
    ...
    return /* @__PURE__ */ jsxs(Fragment, {
      children: [(0, import_react_dom.createPortal)(/* @__PURE__ */ jsxs("code", {
        style: {
          whiteSpace: "pre",
          maxWidth: 250,
          overflow: "auto",
...
var Theme = forwardRef(function(props, ref) {
  ...
  if (ref) try {
    React5.Children.only(finalChildren), finalChildren = cloneElement(finalChildren, {
      ref
    });
  } catch {
  }
...
function getThemedChildren(themeState, children, props, isRoot = false, stateRef, passThrough = false) {
  ...
  if (process.env.NODE_ENV === "development" && props.debug === "visualize" && (children = /* @__PURE__ */ jsx4(ThemeDebug, {
    themeState,
    themeProps: props,
    children
  })), !shouldRenderChildrenWithTheme) return children;
  children = /* @__PURE__ */ jsx4(ThemeStateContext.Provider, {
    value: themeState.id,
    children
  });
  const {
  ...
  themeState.name === "dark" || themeState.name === "light") && (state2.hasEverThemed = "wrapped"), shallow && themeState.parentId) {
    ...
    children = Children.toArray(children).map((child) => isValidElement(child) ? passThrough ? child : cloneElement(child, void 0, /* @__PURE__ */ jsx4(Theme, {
  ...
  if (isWeb) {
    ...
    if (children = /* @__PURE__ */ jsx4("span", {
...
function themeable(Component, staticConfig, optimize = false) {
  const withTheme = React6.forwardRef(function(props, ref) {
    ...
    let contents = /* @__PURE__ */ jsx5(Theme, {
      "disable-child-theme": true,
      ...filteredProps,
      children: element
    });
    if (context2) {
      const Provider = context2.Provider, contextValue = React6.useContext(context2);
      contents = /* @__PURE__ */ jsx5(Provider, {
        ...contextValue,
...
function getStyleTags(styles) {
  if (styles.length) return /* @__PURE__ */ jsx6(Fragment2, {
    children: styles.map((styleObject) => {
      const identifier = styleObject[StyleObjectIdentifier];
      return /* @__PURE__ */ jsx6("style", {
        href: `t_${identifier}`,
        precedence: "default",
...
import { useRef as useRef4, useState } from "react";
var useComponentState = (props, animationDriver, staticConfig, config2) => {
  ...
  const states2 = useState(initialState), state2 = props.forceStyle ? {
    ...states2[0],
...
import { Children as Children2, cloneElement as cloneElement2, forwardRef as forwardRef2, isValidElement as isValidElement2, memo } from "react";
import { Fragment as Fragment3, jsx as jsx7 } from "react/jsx-runtime";
var Slot = memo(forwardRef2(function(props, forwardedRef) {
  const {
    children,
    ...slotProps
  } = props;
  if (isValidElement2(children)) {
    ...
    return cloneElement2(children, children.type.avoidForwardRef ? mergedProps : {
      ...mergedProps,
      ref: composeRefs(forwardedRef, children.props.ref)
    });
  }
  return Children2.count(children) > 1 ? Children2.only(null) : null;
}));
var Slottable = ({
  children
...
function createComponent(staticConfig) {
  ...
  const {
    ...
    isText,
    isHOC
  } = staticConfig, component = React7.forwardRef((propsIn, forwardedRef) => {
    var _a2, _b2, _c, _d, _e, _f, _g;
    config2 || (config2 = getConfig());
    const internalID = process.env.NODE_ENV === "development" ? React7.useId() : "";
    ...
    const {
      context: context2,
      isReactNative
    } = staticConfig, debugProp = propsIn.debug, styledContextValue = context2 ? React7.useContext(context2) : void 0;
    let overriddenContextProps = null;
    const componentContext = React7.useContext(ComponentContext), hasTextAncestor = !!(isWeb && isText && componentContext.inText);
    ...
    props = nextProps, overriddenContextProps = overrides, process.env.NODE_ENV === "development" && isClient && React7.useEffect(() => {
    ...
    const groupContextParent = React7.useContext(GroupContext), animationDriver = (() => {
      var _a3;
...
` && console.error(`Unexpected text node: ${item}. A text node cannot be a child of a <${staticConfig.componentName || propsIn.tag || "View"}>.`, props);
    ...
    let content;
    if (isPassthrough) content = React7.createElement(BaseComponent, {
      style: {
        display: "contents"
      }
    }, propsIn.children);
      ...
      content || (isRenderPropString && viewProps.render, content = React7.createElement(elementType, viewProps, content || children)), process.env.NODE_ENV === "development" && time2 && time2`use-children`;
    }
    ...
    if (needsReset && !hasEverReset && (stateRef.current.hasEverResetPresence = true), (needsReset || hasEverReset) && ResetPresence2 && (content = /* @__PURE__ */ jsx8(ResetPresence2, {
      disabled: !needsReset,
      children: content
    })), process.env.NODE_ENV === "development" && time2 && time2`create-element`, "focusWithinStyle" in propsIn && (content = /* @__PURE__ */ jsx8(ComponentContext.Provider, {
      ...componentContext,
      setParentFocusState: setStateShallow,
      children: content
    })), "group" in props && (content = /* @__PURE__ */ jsx8(GroupContext.Provider, {
      value: allGroupContexts,
      children: content
    })), !asChild && isText && !hasTextAncestor && (content = /* @__PURE__ */ jsx8(ComponentContext.Provider, {
      ...componentContext,
      inText: true,
      children: content
    })), process.env.NODE_ENV === "development" && time2 && time2`group-context`, content = disableTheme || !splitStyles ? content : getThemedChildren(themeState, content, themeStateProps, false, stateRef), process.env.NODE_ENV === "development" && time2 && time2`themed-children`, isReactNative && !asChild && (content = /* @__PURE__ */ jsx8("span", {
      ...
      content = /* @__PURE__ */ jsx8(Provider, {
        __disableMergeDefaultValues: true,
        ...overriddenContextProps,
        children: content
      });
    }
    if (process.env.NODE_ENV === "development" && time2 && time2`context-override`, startedUnhydrated && splitStyles && (content = /* @__PURE__ */ jsxs2(Fragment4, {
  ...
  let res = component;
  res = React7.memo(res), res.staticConfig = staticConfig;
  ...
  function styleable(Component2, options) {
    let out = typeof Component2 == "function" && Component2.length === 1 ? Component2 : React7.forwardRef(Component2);
    const extendedConfig = extendStyledConfig(options == null ? void 0 : options.staticConfig);
    return out = (options == null ? void 0 : options.disableTheme) ? out : themeable(out, extendedConfig, true), (extendedConfig.memo || process.env.TAMAGUI_MEMOIZE_STYLEABLE) && (out = React7.memo(out)), out.staticConfig = extendedConfig, out.styleable = styleable, out;
  }
...
var getCustomRender = (renderProp, content, viewProps, state2) => {
  ...
  if (renderProp && typeof renderProp == "object" && React7.isValidElement(renderProp) && renderProp) {
...
function usePropsAndStyle(props, opts) {
  ...
  }), componentContext = React8.useContext(ComponentContext), groupContext = React8.useContext(GroupContext), {
    state: state2,
    disabled,
    setStateShallow
...
var ResetPresence = (props) => {
  ...
  return /* @__PURE__ */ jsx9(PresenceContext.Provider, {
...
import { View as View2, styled as styled2 } from "@tamagui/core";

// node_modules/@tamagui/stacks/dist/esm/getElevation.mjs
import { getVariableValue as getVariableValue2, isAndroid as isAndroid2, isVariable as isVariable2 } from "@tamagui/core";
var getElevation = (size3, extras) => {
  if (!size3) return;
  const {
    tokens: tokens3
  } = extras, token = tokens3.size[size3], sizeNum = isVariable2(token) ? +token.val : size3;
...
var getSizedElevation = (val, {
  ...
  let num = 0;
  if (val === true) {
    const val2 = getVariableValue2(tokens3.size.true);
...
function NativePortalHost({
  ...
  return /* @__PURE__ */ jsx11(PortalHost2, {
    name
  });
}
function NativePortalProvider({
  ...
  if (getPortal().state.type !== "teleport") return /* @__PURE__ */ jsx11(Fragment5, {
    children
  });
  const {
    PortalProvider: PortalProvider2
  } = globalThis.__tamagui_teleport;
  return /* @__PURE__ */ jsx11(PortalProvider2, {
    children
  });
}
...
var ZIndexStackContext = createContext5(1);
var ZIndexHardcodedContext = createContext5(void 0);

// node_modules/@tamagui/portal/dist/esm/GorhomPortal.mjs
import React13, { createContext as createContext6, memo as memo2, useCallback as useCallback4, useContext as useContext7, useMemo as useMemo2, useReducer } from "react";
...
var PortalStateContext = createContext6(null);
var PortalDispatchContext = createContext6(null);
var usePortalState = (hostName) => {
  const state2 = useContext7(PortalStateContext);
...
var usePortal = (hostName = "root") => {
  ...
  const registerHost2 = useCallback4(() => {
    dispatch({
      type: 0,
      hostName
    });
  }, []), deregisterHost2 = useCallback4(() => {
    dispatch({
      type: 1,
      hostName
    });
  }, []), addUpdatePortal2 = useCallback4((name, node2) => {
    dispatch({
      type: 2,
      hostName,
      portalName: name,
  ...
  }, []), removePortal2 = useCallback4((name) => {
    dispatch({
      type: 3,
      hostName,
      portalName: name
...
var PortalProviderComponent = ({
  ...
  const [state2, dispatch] = useReducer(reducer, INITIAL_STATE), transitionDispatch = useMemo2(() => (value) => {
    startTransition(() => {
      dispatch(value);
    });
  }, [dispatch]), portalState = getPortal().state, content = /* @__PURE__ */ jsx12(PortalDispatchContext.Provider, {
    value: transitionDispatch,
    children: /* @__PURE__ */ jsxs3(PortalStateContext.Provider, {
      value: state2,
      children: [children, shouldAddRootHost && /* @__PURE__ */ jsx12(PortalHost, {
        name: rootHostName
      })]
    })
  });
  return portalState.type === "teleport" ? /* @__PURE__ */ jsx12(NativePortalProvider, {
    children: content
  }) : content;
};
var PortalProvider = memo2(PortalProviderComponent);
PortalProvider.displayName = "PortalProvider";
var defaultRenderer = (children) => /* @__PURE__ */ jsx12(Fragment6, {
  children
});
var PortalHost = memo2(function(props) {
  return isWeb ? /* @__PURE__ */ jsx12(PortalHostWeb, {
    ...props
  }) : getPortal().state.type === "teleport" ? /* @__PURE__ */ jsx12(NativePortalHost, {
    name: props.name
  }) : /* @__PURE__ */ jsx12(PortalHostNonNative, {
    ...props
  });
});
...
function PortalHostNonNative(props) {
  ...
  return useIsomorphicLayoutEffect(() => (registerHost2(), () => {
    ...
    return forwardProps ? React13.Children.map(next, (child) => React13.isValidElement(child) ? React13.cloneElement(child, {
      key: child.key,
      ...restForwardProps
    }) : child) : next;
...
import { getConfig as getConfig2, isVariable as isVariable3 } from "@tamagui/core";
...
var getFontSizeToken = (inSize, opts) => {
  ...
  const relativeSize = (opts == null ? void 0 : opts.relativeSize) || 0, conf4 = getConfig2(), fontSize = ((_a2 = conf4.fontsParsed[(opts == null ? void 0 : opts.font) || conf4.defaultFontToken]) == null ? void 0 : _a2.size) || // fallback to size tokens
...
var getIcon = (el, props) => el && (React14.isValidElement(el) ? React14.cloneElement(el, {
  ...props,
  // @ts-expect-error
  ...el.props
}) : React14.createElement(el, props));
...
var ButtonComponent = Frame.styleable((propsIn, ref) => {
  var _a2;
  const isNested = useContext8(ButtonNestingContext), processedProps = useProps(propsIn, {
    noNormalize: true,
    noExpand: true
  }), {
    children,
  ...
  return /* @__PURE__ */ jsx13(ButtonNestingContext.Provider, {
    value: true,
...
var createTamagui = process.env.NODE_ENV !== "development" ? createTamaguiCore : (conf4) => {
  const sizeTokenKeys = ["$true"], hasKeys = (expectedKeys, obj) => expectedKeys.every((k) => typeof obj[k] < "u"), tamaguiConfig2 = createTamaguiCore(conf4);
...
var TamaguiProvider = ({
  children,
  ...props
}) => /* @__PURE__ */ jsx14(OGProvider, {
  ...props,
  children: /* @__PURE__ */ jsx14(ZIndexStackContext.Provider, {
    value: 1,
    children: /* @__PURE__ */ jsx14(PortalProvider, {
      shouldAddRootHost: true,
      children
    })
  })
...
import { View as View3, styled as styled4, useTheme } from "@tamagui/core";
import React16 from "react";

// node_modules/@tamagui/input/dist/esm/shared.mjs
import { Text as Text3 } from "@tamagui/core";
import { getVariableValue as getVariableValue3, isWeb as isWeb2 } from "@tamagui/core";
var defaultStyles = {
  size: "$true",
  fontFamily: "$body",
  borderWidth: 1,
...
var inputSizeVariant = (val = "$true", extras) => {
  ...
  return !isWeb2 && fontStyle && delete fontStyle.lineHeight, {
    ...fontStyle,
    ...buttonStyles,
    paddingHorizontal
  };
...
var textAreaSizeVariant = (val = "$true", extras) => {
  ...
  const {
    props
  } = extras, buttonStyles = getButtonSized(val, extras), fontStyle = getFontSized(val, extras), lines = (_a2 = props.rows) != null ? _a2 : props.numberOfLines, height = typeof lines == "number" ? lines * getVariableValue3(fontStyle.lineHeight) : "auto";
  !isWeb2 && fontStyle && delete fontStyle.lineHeight;
...
var styledBody = [{
  ...
  validStyles: Text3.staticConfig.validStyles
}];

// node_modules/@tamagui/input/dist/esm/Input.mjs
import { jsx as jsx15 } from "react/jsx-runtime";
var StyledInput = styled4(View3, styledBody[0], styledBody[1]);
var Input = StyledInput.styleable((props, _forwardedRef) => {
  ...
  const {
    ...
    ref,
    composedRef
  } = useWebRef(_forwardedRef), theme = useTheme(), autoCorrect = autoCorrectProp === true ? "on" : autoCorrectProp === false ? "off" : autoCorrectProp, autoCapitalize = autoCapitalizeProp === "sentences" || autoCapitalizeProp === "words" ? "on" : autoCapitalizeProp === "none" || autoCapitalizeProp === "characters" ? "off" : autoCapitalizeProp;
  React16.useEffect(() => {
  ...
  }, [onSelectionChange]), React16.useEffect(() => {
    var _a3;
    selection && ref.current && ref.current.setSelectionRange(selection.start, (_a3 = selection.end) != null ? _a3 : selection.start);
  }, [selection == null ? void 0 : selection.start, selection == null ? void 0 : selection.end]), React16.useEffect(() => {
  ...
  return /* @__PURE__ */ jsx15(StyledInput, {
    ref: composedRef,
    ...finalProps
  });
});
...
import { Text as TamaguiText, styled as styled5 } from "@tamagui/core";
var Text4 = styled5(TamaguiText, {
  variants: {
    unstyled: {
      false: {
        color: "$color"
...
import { ClientOnly, Configuration, ComponentContext as ComponentContext2, GroupContext as GroupContext2, FontLanguage, Theme as Theme2, View as View4, createComponent as createComponent2, createFont as createFont2, createShorthands, createStyledContext as createStyledContext2, createTokens as createTokens2, createVariable as createVariable2, getConfig as getConfig3, getMedia as getMedia2, getCSSStylesAtomic as getCSSStylesAtomic2, getThemes as getThemes2, getToken as getToken2, getTokenValue as getTokenValue2, getTokens as getTokens2, getVariable as getVariable2, getVariableName, getVariableValue as getVariableValue4, insertFont, setConfig as setConfig2, setupDev as setupDev2, isBrowser as isBrowser2, isChrome as isChrome2, isClient as isClient2, isServer as isServer2, isTamaguiComponent, isTamaguiElement, isTouchable, isVariable as isVariable4, isWeb as isWeb3, isWebTouchable as isWebTouchable2, matchMedia, mediaObjectToString as mediaObjectToString2, mediaQueryConfig as mediaQueryConfig2, mediaState as mediaState2, setOnLayoutStrategy, styled as styled6, themeable as themeable2, useDidFinishSSR as useDidFinishSSR2, useEvent, useGet, useIsTouchDevice, useIsomorphicLayoutEffect as useIsomorphicLayoutEffect2, useMedia as useMedia2, useProps as useProps2, usePropsAndStyle as usePropsAndStyle2, useStyle, useConfiguration, useTheme as useTheme2, useThemeName, variableToString as variableToString2, withStaticProperties as withStaticProperties2 } from "@tamagui/core";
...
function createAnimations(animations) {
  ...
  return {
    ...
    useAnimatedNumber(initial) {
      const [val, setVal] = React17.useState(initial), [onFinish, setOnFinish] = useState2();
      return useIsomorphicLayoutEffect(() => {
    ...
    useAnimations: ({
      ...
      var _a2, _b2;
      const isEntering = !!componentState.unmounted, isExiting = (presence == null ? void 0 : presence[0]) === false, sendExitComplete = presence == null ? void 0 : presence[1], wasEnteringRef = React17.useRef(isEntering), justFinishedEntering = wasEnteringRef.current && !isEntering;
      React17.useEffect(() => {
        wasEnteringRef.current = isEntering;
      });
      const exitCycleIdRef = React17.useRef(0), exitCompletedRef = React17.useRef(false), wasExitingRef = React17.useRef(false), exitInterruptedRef = React17.useRef(false), justStartedExiting = isExiting && !wasExitingRef.current, justStoppedExiting = !isExiting && wasExitingRef.current;
      justStartedExiting && (exitCycleIdRef.current++, exitCompletedRef.current = false), justStoppedExiting && (exitCycleIdRef.current++, exitInterruptedRef.current = true), React17.useEffect(() => {
...
import { createFont as createFont3, getVariableValue as getVariableValue5, isWeb as isWeb4 } from "@tamagui/core";
var createInterFont = (font = {}, {
  ...
  return createFont3({
    ...
    lineHeight: Object.fromEntries(Object.entries(size3).map(([k, v]) => [k, sizeLineHeight(getVariableValue5(v))])),
    weight: {
      4: "300"
    },
    letterSpacing: {
...
import { createFont as createFont4, isWeb as isWeb5 } from "@tamagui/core";
var createSilkscreenFont = (font = {}) => createFont4({
  family: isWeb5 ? "Silkscreen, Fira Code, Monaco, Consolas, Ubuntu Mono, monospace" : "Silkscreen",
  size: size2,
...
var AppProvider = ({
  ...
  return /* @__PURE__ */ jsx16(TamaguiProvider, { config: tamagui_config_default, defaultTheme, children: /* @__PURE__ */ jsx16(Theme2, { name: defaultTheme, children }) });
};
...
var Button2 = ({ title, onPress, full }) => {
  return /* @__PURE__ */ jsx17(
    Button,
    {
      ...
      children: /* @__PURE__ */ jsx17(Text4, { color: "white", children: title })
    }
  );
};
...
var TextField = ({ label, value, onChangeText }) => {
  return /* @__PURE__ */ jsxs5(YStack, { gap: "$2", children: [
    label && /* @__PURE__ */ jsx18(Text4, { fontWeight: "600", children: label }),
    /* @__PURE__ */ jsx18(
      Input,
      {
        value,
